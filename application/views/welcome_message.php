                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Welcome to Koperasi Siswazah Bangi Berhad</li>
                                </ol>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card mini-stat bg-tabs">
                                <div class="card-body mini-stat-img">
                                    ...
                                    <div class="text-white">
                                        <h6 class="text-uppercase mb-3">Fees</h6>
                                        <h4 class="mb-4">$46,782</h4><span class="badge badge-danger">-29% </span><span class="ml-2">From previous period</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="card mini-stat bg-tabs">
                                <div class="card-body mini-stat-img">
                                    ...
                                    <div class="text-white">
                                        ...
                                        <h4 class="mb-4">15</h4><span class="badge badge-warning">0% </span><span class="ml-2">From previous period</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="card mini-stat bg-tabs">
                                <div class="card-body mini-stat-img">
                                    ...
                                    <div class="text-white">
                                        ...
                                        <h4 class="mb-4">1890</h4><span class="badge badge-info">+89% </span><span class="ml-2">From previous period</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card widget-user m-b-20">
                                <div class="widget-user-desc p-4 text-center bg-primary position-relative"><i class="fas fa-quote-left h3 text-white-50"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div>
                                                <h4>52,345</h4>
                                                <p class="text-muted">The languages only differ grammar</p><a href="#" class="text-primary">Learn more <i class="mdi mdi-chevron-double-right"></i></a></div>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-vertical">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><img src="assets/images/users/user-3.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"> Mathias N. Klausen</td>
